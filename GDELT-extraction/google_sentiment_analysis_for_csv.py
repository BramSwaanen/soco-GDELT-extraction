...
def analyze_sentiment_in_csv(csv_file: str, output_csv: str) -> None:
    ...
    for text_content in df['MainText']:  # Assumes 'MainText' column has the text content
        document = {
...
# Example usage
analyze_sentiment_in_csv('outpu_cat_data.csv', 'Google_output_with_sentiment_no_robots.csv')
